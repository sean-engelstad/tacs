#include "TACSTieElement.h"

/*
  A Nastran MPC or TIE constraint.
  ...
  Author of this file : Sean Engelstad, Georgia Tech SMDO Lab
  ...
  based on TIE constraints. Using this method, the entries of the
  ...
  represent the reaction forces on the each dependent grid due to the TIE Element.
...
/*
  Create the TACS Tie Element
*/
TACSTieElement::TACSTieElement(int _numNodes, int _dof_constrained[]) {
...
*/
const char *TACSRBE2::elemName = "TACSTIE";
